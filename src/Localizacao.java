...
public class Localizacao {
     ...
     * 
     * @return Uma representação textual da localização.
     */
     ...
     * a coluna. Exceto em grades muito grandes, isso deve gerar
     * um código hash exclusivo para cada par (linha, coluna).
     */
    public int hashCode() {
