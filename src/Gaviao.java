...
public class Gaviao extends Animal {
    // Constantes específicas da classe Gaviao
    // Idade em que o gavião pode começar a se reproduzir
    private static final int IDADE_REPRODUTIVA = 5;
    // Idade máxima que um gavião pode atingir
    private static final int IDADE_MAXIMA = 70;
    // Probabilidade de reprodução do gavião
    private static final double PROBABILIDADE_REPRODUCAO = 0.08;
    // Tamanho máximo da ninhada do gavião
    private static final int TAMANHO_MAXIMO_NINHADA = 3;
    // Valor alimentar de um rato para o gavião
    ...
    public Gaviao(boolean idadeAleatoria) {
        ...
        setNivelAlimento(VALOR_ALIMENTAR); // Começa bem alimentado
    ...
    /**
     * Encontra comida adjacente (Ratos). Se encontrar, come e retorna a localização.    
